 ...
 * AppleWifiNlpBackend: AppleWifiNlpBackend UnifiedNlp backend that uses Apple's service to resolve wifi locations.Location calculation is done onboard and wifi locations are cached to minimize data usage. [here](https://github.com/microg/AppleWifiNlpBackend)
